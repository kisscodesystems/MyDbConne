...
*/
  protected final String appName = "MyDbConns" ;
  protected final String appVersion = "1.4" ;
...
*/
  ...
  protected final Utils us = new Utils ( ) ;
/*
...
*/
  ...
  protected final String bit = "bit" ;
  protected final String tinyblob = "tinyblob" ;
  protected final String mediumblob = "mediumblob" ;
  protected final String longblob = "longblob" ;
...
*/
  protected final String fileFilePrefix = "    file:///" ;
...
*/
  protected final String dbTypeMysql = "mysql" ;
  ...
  protected final String dbTypeDriverSearchMysql = "mysql" ;
...
*/
  ...
  protected final String promptMysql = appName + spaceChar + dbTypeMysql + dbConnToChangeInPrompt + promptEnding ;
...
*/
  ...
  protected final String messageNoRowsSelected = "No rows selected." ;
  protected final String message1RowSelected = "1 row selected." ;
...
*/
  ...
  protected final String messageWelcomeScreen = newLineString + fold + "Welcome to " + appName + "!" + newLineChar + fold + newLineChar + fold + "Type " + dbTypeMysql + " or " + dbTypeOracle + " or " + dbTypeMssql + " or " + dbTypeDb2 + " or " + dbTypePostgresql + " to use the specific database!" + newLineChar + fold + "Type " + promptToUpperOrExit + " to return to upper levels or exit!" + newLineChar + fold + "Type " + argQuestionMark + " or " + argHelp + " for more information about using this application!" ;
  ...
  protected final String messageDriverForMysqlHasToContain = newLineString + fold + "The driver for Mysql has to contain: " ;
  ...
  protected final String messageIsFolderSafe = newLineString + fold + "As the first step, please move the classes of this " + appName + newLineChar + fold + "into a safe (local personal) folder or into a removable device!" + newLineChar + fold + newLineChar + fold + "Is the folder of this " + appName + ".jar safe enough?" + newLineChar + fold + messageTypeYesElseAnything ;
